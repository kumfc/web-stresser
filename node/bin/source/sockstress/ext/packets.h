...
struct __attribute__((packed)) myiphdr {
#ifdef BIGENDIAN
	uint8_t		version:4;
	uint8_t		ihl:4;
#else
...
struct __attribute__((packed)) myudphdr {
	uint16_t	source;
	uint16_t	dest;
	uint16_t	len;
	uint16_t	check;
...
struct __attribute__((packed)) mytcphdr {
	uint16_t	source;
	uint16_t	dest;
	uint32_t	seq;
	uint32_t	ack_seq;
...
struct __attribute__((packed)) myicmphdr {
...
struct __attribute__((packed)) myetherarphdr {
	uint16_t hw_type;
	uint16_t protocol;
	uint8_t hwsize;
	uint8_t protosize;
...
struct __attribute__((packed)) myarphdr {
	uint16_t hw_type;
	uint16_t protocol;
	uint8_t hwsize;
	uint8_t protosize;
...
struct __attribute__((packed)) my6etherheader {
